...
var randomeImageSource1="images/dice"+randomNumber1+".png";
var image1=document.querySelectorAll("img")[0];
image1.setAttribute("src",randomeImageSource1);
...
if(randomNumber1>randomNumber2){
    ...
    document.querySelector("h1").innerHTML="tie breaker Play again !";
